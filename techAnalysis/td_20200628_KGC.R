...
getSymbols("KGC", from = "2015-01-01", src = "yahoo")
candleChart(KGC, subset = "2020") # 
addSMA(n = 10, col = "white")
addSMA(n = 50, col = "blue")
addSMA(n = 200, col = "red")
addRSI(n = 14, maType = "EMA")
...
getSymbols("AUY", from = "2015-01-01", src = "yahoo") # 
candleChart(AUY, subset = "2020")
addSMA(n = 10, col = "white")
addSMA(n = 50, col = "blue")
addSMA(n = 200, col = "red")
addRSI(n = 14, maType = "EMA")
...
getSymbols("BTG", from = "2015-01-01", src = "yahoo") # 
candleChart(BTG, subset = "2020")
addSMA(n = 10, col = "white")
addSMA(n = 50, col = "blue")
addSMA(n = 200, col = "red")
addRSI(n = 14, maType = "EMA")
...
getSymbols("AGI", from = "2015-01-01", src = "yahoo") # 
candleChart(AGI, subset = "2020")
addSMA(n = 10, col = "white")
addSMA(n = 50, col = "blue")
addSMA(n = 200, col = "red")
addRSI(n = 14, maType = "EMA")
