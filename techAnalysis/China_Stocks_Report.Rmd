...
```{r message=FALSE, warning=FALSE}
return_report <- get_data(stocksGeneral, '2021-01-01', 0.10, -0.5)
```
...
## EV Stocks
```{r}
return_report <- get_data(stocksEV, '2021-01-01', 0.10, -0.5)
```
...
## Financial Stocks
```{r}
return_report <- get_data(stocksFin, '2021-01-01', 0.10, -0.5)
```
...
```{r}
return_report <- get_data(stocksSolar, '2021-01-01', 0.10, -0.5)
```
...
```{r}
return_report <- get_data(stocksEdu, '2021-01-01', 0.10, -0.5)
```
...
```{r}
return_report <- get_data(stocksOther, '2021-01-01', 0.10, -0.5)
```
